...
def define_generator(noise_length, word_length):    
    ...
    model.add(tf.keras.layers.Dense(word_length*30, activation=tf.nn.relu))
...
#xx = np.resize(train_dataX_fake, (100,7,30))
...
#%%  
    ...
    # Generate names
    latent_noise = generate_latent_noise(10000, 8)
    ...
    res = func.preds_to_letters(gen_names)
